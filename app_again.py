...
TRANSLATION_DICT = {
    ...
    'marital-status': {
        'Never-married': 'Никогда не был женат/замужем',
    ...
    'workclass': {
        'Private': 'Частный',
        'Self-emp-not-inc': 'Самозанятый (не инкорпорированный)',
        'Self-emp-inc': 'Самозанятый (инкорпорированный)',
    ...
    'occupation': {
        ...
        'Adm-clerical': 'Административный',
        'Sales': 'Продажи',
        'Other-service': 'Другие услуги',
        'Machine-op-inspct': 'Машинные операторы-инспекторы',
        'Transport-moving': 'Транспортировка',
        'Handlers-cleaners': 'Низкоквалифицированные',
